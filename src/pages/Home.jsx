        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <div className="flex flex-col justify-center mt-10 space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4 animate-fade-in">
              <a  className="inline-flex items-center justify-center w-full px-8 py-3 text-base font-medium text-purple-600 transition-colors duration-300 bg-white border border-transparent rounded-md shadow-md sm:w-auto hover:bg-gray-50 hover:shadow-lg md:py-4 md:text-lg md:px-10">
              ...
              <a  className="inline-flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white transition-colors duration-300 bg-purple-600 border border-transparent rounded-md shadow-md sm:w-auto hover:bg-purple-700 hover:shadow-lg md:py-4 md:text-lg md:px-10">
